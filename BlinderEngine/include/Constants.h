...
namespace Constants
{
	...
	const std::string alice_attack_animation_path = "./resources/objects/alice/animation/attacking.dae";
	...
	const std::string carol_attack_animation_path = "./resources/objects/carol/animation/carol_spell.dae";
