...
void AliceSkill::SetUp(glm::mat4 model) {
    if (!setup) {
        dest = glm::vec3(model * glm::vec4(0.0f, 3.0f, -12.0f, 1.0f));
        ...
        leadingparticles[0]->Velocity = (dest - leadingparticles[0]->Position) / 2.0f;
        leadingparticles[1]->Velocity = (dest - leadingparticles[1]->Position) / 2.0f;
        leadingparticles[2]->Velocity = (dest - leadingparticles[2]->Position) / 2.0f;
        leadingparticles[3]->Velocity = (dest - leadingparticles[3]->Position) / 2.0f;
        start = true;
        setup = true;
    }
}
