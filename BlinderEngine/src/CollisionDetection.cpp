...
bool checkerLogic( int mapID, std::vector<std::pair<float, float>> points){
    if (mapID == 0 || mapID == 2) { // animal
        ...
        if(type01==1){
            ...
            if (tile == 3 || tile == 2) {
                std::cout<<"colliding left wall on point 0&1!"<<std::endl;
                return true;
            }
        }
        ...
        if(type23==1){
            ...
            if (tile == 3 || tile == 2) {
                std::cout<<"colliding left wall on point 2&3!"<<std::endl;
                return true;
            }
        }
        ...
        if(type02==2){
            ...
            if (tile == 3 || tile == 1) {
                std::cout<<"colliding top wall on point 0&2!"<<std::endl;
                return true;
            }
        }else if(type02==3){
            //std::cout<<"type02: "<< type02 <<std::endl;
            ...
            if (tile1 == 3 || tile1 == 1) {
                std::cout<<"colliding type3 top wall on point 0&2!"<<std::endl;
                return true;
            }
            int tile2 = MAP_ENCODING[mapID][(int)(points[0].first)][(int)(points[0].second)];
            if (tile2 == 3 || tile2 == 2) {
                std::cout<<"colliding type3 left wall on point 0&2!"<<std::endl;
                return true;
            }
        }else if(type02==4){
        ...
        if(type13==2){
            ...
            int tile = MAP_ENCODING[mapID][(int)(points[3].first)][(int)(points[3].second)];
            if (tile == 3 || tile == 1) {
                std::cout<<"colliding top wall on point 1&3!"<<std::endl;
                return true;
            }
        }else if(type13==3){
            int tile1 = MAP_ENCODING[mapID][(int)(points[3].first)][(int)(points[3].second)];
            if (tile1 == 3 || tile1 == 1) {
                std::cout<<"colliding type3 top wall on point 1&3!"<<std::endl;
                return true;
            }
            int tile2 = MAP_ENCODING[mapID][(int)(points[1].first)][(int)(points[1].second)];
            if (tile2 == 3 || tile2 == 2) {
                std::cout<<"colliding type3 left wall on point 1&3!"<<std::endl;
                return true;
            }
        }else if(type13==4){
        ...
        if(type02==2){
            ...
            int tile1 = MAP_ENCODING[mapID][(int)(points[2].first)][(int)(points[2].second)];
            if (tile1 == 3 || tile1 == 1) {
                std::cout<<"colliding type4 top wall on point 0&2!"<<std::endl;
                return true;
            }
            int tile2 = MAP_ENCODING[mapID][(int)(points[0].first)][(int)(points[2].second)];
            if (tile2 == 3 || tile2 == 2) {
                std::cout<<"colliding type4 left wall on point 0&2!"<<std::endl;
                return true;
            }
        }
        ...
        if(type13==2){
            ...
            int tile1 = MAP_ENCODING[mapID][(int)(points[3].first)][(int)(points[3].second)];
            if (tile1 == 3 || tile1 == 1) {
                std::cout<<"colliding type4 top wall on point 1&3!"<<std::endl;
                return true;
            }
            int tile2 = MAP_ENCODING[mapID][(int)(points[1].first)][(int)(points[3].second)];
            if (tile2 == 3 || tile2 == 2) {
                std::cout<<"colliding type4 left wall on point 1&3!"<<std::endl;
                return true;
            }
        }
    }
...
bool CollisionDetection::checkCollisionWithWall(int mapID, std::vector<std::pair<float, float>> points_org) {
    ...
    if(points_org.size()==4){
        ...
        if(mapID==0 && points.at(0).first>4.0f){
            ...
            if(returnlogic){
                std::cout<< "8 points map1 collision on edge 2"<<std::endl;
                return true;
            }
            for(int i=0;i<4;i++){
            ...
            if(returnlogic){
                std::cout<< "8 points map0 collision on edge 3"<<std::endl;
                return true;
            }
            for(int i=0;i<4;i++){
                points.at(i)=points_org.at(i+4);
            ...
            returnlogic=checkerLogic( 1,points);
            if(returnlogic){
                std::cout<< "8 points map1 collision on edge 1"<<std::endl;
                return true;
            }
            for(int i=0;i<4;i++){
                points.at(i)=points_org.at(i+4);
            ...
            returnlogic=checkerLogic( 0,points);
            if(returnlogic){
                std::cout<< "8 points map0 collision on edge 4"<<std::endl;
                return true;
            }
            for(int i=0;i<4;i++){
                points.at(i)=points_org.at(i+4);
